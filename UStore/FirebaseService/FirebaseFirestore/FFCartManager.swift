...
class FFCartManager  {
    ...
    func addListenerForAllUserCartsProducts() async throws{
        dbCollection.addSnapshotListener{querySnapshot , error in
        }
    }
        //  MARK: - Listener für alle Cart-Produkte des aktuellen Benutzers -
        /*
        ...
        func createCart(product : Product) throws {
            ...
            do {
                try dbCollection.addDocument(from: cart)
            } catch {
